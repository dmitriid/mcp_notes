defmodule McpNotesWeb.Components.Overlay do
  @moduledoc """
  The `McpNotesWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `McpNotesWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
