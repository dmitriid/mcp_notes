defmodule McpNotesWeb.Components.Stepper do
  @moduledoc """
  The `McpNotesWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `McpNotesWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
