defmodule McpNotesWeb.Components.Clipboard do
  @moduledoc """
  The `McpNotesWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
