defmodule McpNotesWeb.Components.Banner do
  @moduledoc """
  McpNotesWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
