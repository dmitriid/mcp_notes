defmodule McpNotesWeb.Components.FileField do
  @moduledoc """
  The `McpNotesWeb.Components.FileField` module provides a versatile and customizable component
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(McpNotesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(McpNotesWeb.Gettext, "errors", msg, opts)
    end
  end
end
