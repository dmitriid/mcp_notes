defmodule McpNotesWeb.Components.Alert do
  @moduledoc """
  McpNotesWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
