defmodule McpNotesWeb.Components.NativeSelect do
  @moduledoc """
  The `McpNotesWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `McpNotesWeb.Components.NativeSelect`
