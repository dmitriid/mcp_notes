defmodule McpNotesWeb.Components.Menu do
  @moduledoc """
  The `McpNotesWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `McpNotesWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import McpNotesWeb.Components.Accordion, only: [accordion: 1]
  import McpNotesWeb.Components.Button, only: [button_link: 1]
