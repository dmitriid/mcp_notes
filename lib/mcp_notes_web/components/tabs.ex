defmodule McpNotesWeb.Components.Tabs do
  @moduledoc """
  `McpNotesWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import McpNotesWeb.Components.Badge, only: [badge: 1]
