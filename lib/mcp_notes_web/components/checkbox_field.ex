defmodule McpNotesWeb.Components.CheckboxField do
  @moduledoc """
  McpNotesWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
