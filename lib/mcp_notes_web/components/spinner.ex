defmodule McpNotesWeb.Components.Spinner do
  @moduledoc """
  The `McpNotesWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `McpNotesWeb.Components.Spinner` module enables developers to provide
