defmodule McpNotesWeb.Components.Divider do
  @moduledoc """
  The `McpNotesWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `McpNotesWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
