defmodule McpNotesWeb.Components.ScrollArea do
  @moduledoc """
  The `McpNotesWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
