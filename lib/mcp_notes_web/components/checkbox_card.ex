defmodule McpNotesWeb.Components.CheckboxCard do
  @moduledoc """
  The `McpNotesWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
